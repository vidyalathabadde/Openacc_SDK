...
#pragma omp loop reduction(+:tmp0) reduction(+:tmp1) reduction(+:tmp2)\
            reduction(+:tmp3)
...
// Code was translated using: /nfs/site/home/vbaddex/vidya/openacc/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp histogram.c
