...
#pragma omp loop reduction(+:sum,sum2)
    ...
    printf("Above confidence values\n");
    }
    printf("break 3\n");
    //acc_wait_all();
    #pragma omp taskwait
...
void runtest(float thresh)
{
    ...
    {
        omp_set_default_device(omp_get_thread_num()+1/*, acc_device_nvidia*/);
...
// Code was translated using: /nfs/site/home/vbaddex/vidya/openacc/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp Mon
