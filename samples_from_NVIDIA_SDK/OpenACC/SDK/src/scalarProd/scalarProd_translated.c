...
#pragma omp target enter data map(to:A[0:DATA_N],B[0:DATA_N])\
            map(alloc:D[0:VECTOR_N])
...
#pragma omp target exit data map(from:D[0:VECTOR_N]) map(delete:A[0:DATA_N],\
            B[0:DATA_N])
}
...
// Code was translated using: /nfs/site/home/vbaddex/vidya/openacc/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp scalarProd.c
